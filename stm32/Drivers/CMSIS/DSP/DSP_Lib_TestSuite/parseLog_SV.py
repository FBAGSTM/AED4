...
def parseLog(toolchain, core, test):
    ...
    inFileName = ".\DspLibTest_SV_{2}\{0}\Logs\DspLibTest_{2}_{1}.log".format(
        toolchain, core, test
    )
    outFileName = ".\DspLibTest_SV_{2}\{0}\Logs\DspLibTest_{2}_{1}_parsed.log".format(
        toolchain, core, test
    )
